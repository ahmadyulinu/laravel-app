...
<div class="card mt-5">
    <div class="card-body card-block p-4">
        <h2><strong>Tambah Artikel Berita</strong></h2>
        <br>
        ...
        <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="article_image" name="article_image" class="form-control">
            </div>

            <div class="form-group">
                <label for="article_content" class="form-control-label">Isi Artikel</label>
                <textarea type="text" id="article_content" name="article_content" class="form-control"></textarea>
            </div>
